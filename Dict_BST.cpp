...
// this is used to Create Dictionary using BST with no input and return nothing.
void Dict::create()
{
    node *temp;
	temp = new node;
...
//This is used to add new node in existing tree pointed byroot.
...
//This is used to display the nodes in RVL way
...
/*It takes three parameters namely root, value to be search and parent as input. It returns
NULL of parent if data not found or found respectively.*/
	...
	while(1)
	{
		...
		switch(op)
		{
			...
			case 4:     
			    ...
			    cin>>key; B.search(B.root, key); 
			    break;
			case 5: 
			    cout<<"\nEnter word you want to modify: "; 
			    cin>>key; B.modify(B.root, key); 
			    break;
			case 6: 
			    cout<<"\nEnter word you want to delete: "; 
			    cin>>key; B.root = B.deleteNode(B.root, key); 
			    break;
			case 7: 
			    exit(1); 
			    break;
